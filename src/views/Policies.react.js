    ...
    return(
      <main className="policies">
        <div className="container">
          ...
          <p>This Privacy Policy governs the manner in which Fast Stream Conference collects, uses, maintains and discloses information collected from users (each, a "User") of the http://fsconference.co.uk website ("Site").</p>
